...
$q="CREATE TABLE Adverts(BusinessName $varchar,businessID $int,products $varchar,BusnessLink $varchar,location $varchar,businessDescrption $varchar)";
$q="CREATE TABLE passwords(customerID $int,password VARCHAR(1000) NOT NULL)";
echo $q="CREATE TABLE Admin(username $varchar,password $varchar,PRIMARY KEY(username))";
mysqli_query($conn,$q);
#############################################configurartion####################################
$username="leontech";
$password="leon123";
